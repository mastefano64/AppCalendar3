...
@Component({
  selector: 'app-pageassignment2',
  templateUrl: './page-assignment2.component.html',
  styleUrls: ['./page-assignment2.component.css'],
  providers: [ CalendarAssignmentService ]
})
export class PageAssignment2Component implements OnInit {
  year: number;
  month: number;
  day: number;
