...
@Component({
  selector: 'app-pageassignment1',
  templateUrl: './page-assignment1.component.html',
  styleUrls: ['./page-assignment1.component.css'],
  providers: [ CalendarAssignmentService ]
})
export class PageAssignment1Component implements OnInit {
  year: number;
  month: number;
  day: number;
